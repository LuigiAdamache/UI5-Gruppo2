...
], function (BaseController, JSONModel, formatter, Filter, FilterOperator, History, UIComponent, Fragment, Sorter, ExportTypeCSV, Spreadsheet) {
    "use strict";

    return BaseController.extend("suppliers.suppliers.controller.Worklist", {
        ...
        onSort: function () {
            ...
            if (!this.byId("sortDialog")) {
                Fragment.load({
                    id: oView.getId(),
                    name: "suppliers.suppliers.fragment.Sort",
                    controller: this
        ...
        onSortDialogConfirm: function (oEvent) {
            ...
            var sSupplierID = "SupplierID";
            var Descending = oEvent.getParameter("sortDescending");
            var oSorters = [];

            if (oSortItem) {
                sSupplierID = oSortItem.getKey();
            }
            oSorters.push(new Sorter(sSupplierID, Descending));
            var oTable = this.getView().byId("table");
            var oBinding = oTable.getBinding("items");
