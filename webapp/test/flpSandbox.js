		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#GestionedeiFornitori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GestionedeiFornitori-display": {
								"semanticObject": "GestionedeiFornitori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=suppliers.suppliers",
									"url": sap.ui.require.toUrl("suppliers/suppliers")
								}
							}
						}
					}
